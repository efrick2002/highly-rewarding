...
@register_model_class("thurstone-mlp-detached-var-reward-model")
def get_thurstone_mlp_detached_var_reward_model_class(
    model_type: str, tokenizer: PreTrainedTokenizer, init_type: str = "reset_params"
) -> PreTrainedModel:
    # Should construct and return the model class such that the trainer can call .from_pretrained on it.
    ...
    class RewardModel(RewardPretrainedModel):
        ...
        def forward(self, input_ids, attention_mask):
            ...
            means = self.mean_head(cls_hidden_dim)
            logvars = self.logvar_head(cls_hidden_dim.detach())
...
@register_model_class("thurstone-mlp-2-reward-model")
def get_thurstone_mlp_2_reward_model_class(
    model_type: str, tokenizer: PreTrainedTokenizer, init_type: str = "reset_params"
) -> PreTrainedModel:
    # Should construct and return the model class such that the trainer can call .from_pretrained on it.
...
@register_model_class("double-cls-mlp-thurstone-reward-model")
def get_double_cls_mlp_thurstone_reward_model_class(
    model_type: str, tokenizer: PreTrainedTokenizer, init_type: str = "reset_params"
) -> PreTrainedModel:
    # Should construct and return the model class such that the trainer can call .from_pretrained on it.
...
@register_model_class("double-cls-mlp-2-thurstone-reward-model")
def get_double_cls_mlp_2_thurstone_reward_model_class(
    model_type: str, tokenizer: PreTrainedTokenizer, init_type: str = "reset_params"
) -> PreTrainedModel:
    # Should construct and return the model class such that the trainer can call .from_pretrained on it.
